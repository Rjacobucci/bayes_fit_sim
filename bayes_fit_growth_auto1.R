  ...
  for(j in 1:length(samps)){
    for(k in 1:length(mods)){
      ...
      if(inherits(fit1, "try-error")){
        ...
        fit.ret[count,"iters1"] <- fit1@Fit@iterations
      ...
      if(inherits(fit2, "try-error")){
        ...
        fit.ret[count,"iters2"] <- fit2@Fit@iterations
      ...
      if(inherits(fit3, "try-error")){
        ...
        fit.ret[count,"iters3"] <- fit3@Fit@iterations
      ...
      if(inherits(fit4, "try-error")){
        ...
        fit.ret[count,"iters4"] <- fit4@Fit@iterations
